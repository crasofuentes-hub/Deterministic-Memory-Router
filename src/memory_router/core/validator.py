...
def validate_fuser_output_semantic(
    payload: Dict[str, Any], allowed_snippet_refs: Set[str]
) -> None:
    # schema
...
def validate_fuser_output(
    payload: Dict[str, Any], registry: SchemaRegistry, allowed_snippet_refs: Set[str]
) -> None:
